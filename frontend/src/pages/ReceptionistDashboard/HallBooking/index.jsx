            ...
            <form onSubmit={handleBookingSubmit} className="p-6 grid gap-4 md:grid-cols-2">
              ...
              <div className="md:col-span-2 flex justify-end gap-3 pt-2">
                {editingHallBookingId && (
                  <button type="button" onClick={() => handleDeleteHallBooking(editingHallBookingId)} className="px-4 py-2.5 rounded-lg bg-red-600 text-white font-semibold hover:bg-red-700 inline-flex items-center gap-2">
