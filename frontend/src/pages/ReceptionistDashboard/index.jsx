...
const quickActions = [
  {
    title: 'Hall Bookings',
    description: 'Review and manage hall reservation requests.',
    icon: Building2,
    href: '/hall-bookings',
  },
  {
    title: 'Vehicle Bookings',
    description: 'Track transport requests and booking status.',
    icon: CarFront,
    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-slate-900 leading-tight">Receptionist Dashboard</h1>
                <p className="text-xs text-indigo-600">Front desk and booking coordination</p>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <h2 className="mt-2 text-3xl font-bold text-slate-900">Welcome back, {user?.name || 'Receptionist'}</h2>
